...
delete a["aria-selected"]);for(var l in a)b.setAttribute(l,a[l]);if(c.children){a=e(b);l=document.createElement("strong");l.className="select2-results__group";e(l);this.template(c,l);for(var d=[],r=0;r<c.children.length;r++){var f=this.option(c.children[r]);d.push(f)}r=e("\x3cul\x3e\x3c/ul\x3e",{"class":"select2-results__options select2-results__options--nested"});r.append(d);a.append(l);a.append(r)}else this.template(c,b);e.data(b,"data",c);return b};d.prototype.bind=function(c,b){var a=this;this.$results.attr("id",
...
b,!0)};c.prototype.processResults=function(b){return b};c.prototype.query=function(b,a){function c(){var l=e.transport(e,function(c){c=g.processResults(c,b);g.options.get("debug")&&window.console&&console.error&&(c&&c.results&&d.isArray(c.results)||console.error("Select2: The AJAX results did not return an array in the `results` key of the response."));a(c)},function(){l.status&&"0"===l.status||g.trigger("results:message",{message:"errorLoading"})});g._request=l}var g=this;null!=this._request&&(d.isFunction(this._request.abort)&&
this._request.abort(),this._request=null);var e=d.extend({type:"GET"},this.ajaxOptions);"function"===typeof e.url&&(e.url=e.url.call(this.$element,b));"function"===typeof e.data&&(e.data=e.data.call(this.$element,b));this.ajaxOptions.delay&&null!=b.term?(this._queryTimeout&&window.clearTimeout(this._queryTimeout),this._queryTimeout=window.setTimeout(c,this.ajaxOptions.delay)):c()};return c});h.define("select2/data/tags",["jquery"],function(e){function f(d,c,b){var a=b.get("tags"),l=b.get("createTag");
void 0!==l&&(this.createTag=l);l=b.get("insertTag");void 0!==l&&(this.insertTag=l);d.call(this,c,b);if(e.isArray(a))for(d=0;d<a.length;d++)c=this._normalizeItem(a[d]),c=this.option(c),this.$element.append(c)}f.prototype.query=function(d,c,b){function a(d,f){for(var h=d.results,m=0;m<h.length;m++){var n=h[m],q=null!=n.children&&!a({results:n.children},!0),n=(n.text||"").toUpperCase(),t=(c.term||"").toUpperCase();if(n===t||q){if(f)return!1;d.data=h;b(d);return}}if(f)return!0;m=e.createTag(c);null!=
m&&(q=e.option(m),q.attr("data-select2-tag",!0),e.addOptions([q]),e.insertTag(h,m));d.results=h;b(d)}var e=this;this._removeOldTags();null==c.term||null!=c.page?d.call(this,c,b):d.call(this,c,a)};f.prototype.createTag=function(d,c){var b=e.trim(c.term);return""===b?null:{id:b,text:b}};f.prototype.insertTag=function(d,c,b){c.unshift(b)};f.prototype._removeOldTags=function(d){this.$element.find("option[data-select2-tag]").each(function(){this.selected||e(this).remove()})};return f});h.define("select2/data/tokenizer",
["jquery"],function(e){function f(d,c,b){var a=b.get("tokenizer");void 0!==a&&(this.tokenizer=a);d.call(this,c,b)}f.prototype.bind=function(d,c,b){d.call(this,c,b);this.$search=c.dropdown.$search||c.selection.$search||b.find(".select2-search__field")};f.prototype.query=function(d,c,b){var a=this;c.term=c.term||"";var l=this.tokenizer(c,this.options,function(b){var c=a._normalizeItem(b);a.$element.find("option").filter(function(){return e(this).val()===c.id}).length||(b=a.option(c),b.attr("data-select2-tag",
!0),a._removeOldTags(),a.addOptions([b]));a.trigger("select",{data:c})});l.term!==c.term&&(this.$search.length&&(this.$search.val(l.term),this.$search.focus()),c.term=l.term);d.call(this,c,b)};f.prototype.tokenizer=function(d,c,b,a){d=b.get("tokenSeparators")||[];b=c.term;for(var l=0,g=this.createTag||function(a){return{id:a.term,text:a.term}};l<b.length;)if(-1===e.inArray(b[l],d))l++;else{var f=b.substr(0,l),f=e.extend({},c,{term:f}),f=g(f);null==f?l++:(a(f),b=b.substr(l+1)||"",l=0)}return{term:b}};
return f});h.define("select2/data/minimumInputLength",[],function(){function e(e,d,c){this.minimumInputLength=c.get("minimumInputLength");e.call(this,d,c)}e.prototype.query=function(e,d,c){d.term=d.term||"";d.term.length<this.minimumInputLength?this.trigger("results:message",{message:"inputTooShort",args:{minimum:this.minimumInputLength,input:d.term,params:d}}):e.call(this,d,c)};return e});h.define("select2/data/maximumInputLength",[],function(){function e(e,d,c){this.maximumInputLength=c.get("maximumInputLength");
...
this.on("disable",function(){a.$container.addClass("select2-container--disabled")});this.on("blur",function(){a.$container.removeClass("select2-container--focus")});this.on("query",function(b){a.isOpen()||a.trigger("open",{});this.dataAdapter.query(b,function(c){a.trigger("results:all",{data:c,query:b})})});this.on("query:append",function(b){this.dataAdapter.query(b,function(c){a.trigger("results:append",{data:c,query:b})})});this.on("keypress",function(b){var d=b.which;if(a.isOpen())if(d===c.TAB){a.options.set("okToSelectOnClose",
!0);a.close();b.preventDefault();a.options.set("okToSelectOnClose",!1);b=b.shiftKey?-1:1;var d=a.$element[0],f=d.form;if(f){for(var h=f.elements,f=[],m=0,n=h.length;m<n;m++)"hidden"==h[m].type||"none"==h[m].style.display||h[m].readOnly||h[m].disabled||f.push(h[m]);m=0;for(n=f.length;m<n;m++)if(h=f[m],d==h)for(var q=1;q<f.length;q++)if(idx=m+b*q,0>idx&&(idx=n+idx),idx>=n&&(idx-=n),h=f[idx],h.focus&&e(h).is(":visible")&&-2!=e(h).attr("tabindex")&&!e(h).prop("no-tab")){h.focus();break}}}else d===c.ESC||
d===c.UP&&b.altKey?(a.close(),b.preventDefault()):d===c.ENTER?(a.options.set("okToSelectOnClose",!0),a.close(),b.preventDefault(),a.options.set("okToSelectOnClose",!1),a.$element[0].focus()):d===c.SPACE&&b.ctrlKey?(a.trigger("results:toggle",{}),b.preventDefault()):d===c.UP?(a.trigger("results:previous",{}),b.preventDefault()):d===c.DOWN&&(a.trigger("results:next",{}),b.preventDefault());else if(d===c.ENTER||d===c.SPACE||d===c.DOWN&&!b.ctrlKey)a.open(),b.preventDefault();else if(d>=c.ZERO&&d<=c.NINE||
d>=c.NUMZERO&&d<=c.NUMSTAR||d>=c.NUMSUBTRACT&&d<=c.DIVIDE||d>=c.A&&d<=c.Z||d>=c.SEMICOLON&&d<=c.GRAVE||d>=c.OPENBRACKET&&d<=c.SINGLEQUOTE)a.open(),a.dropdown.$search.val(b.key),a.trigger("selection:update"),b.preventDefault()})};b.prototype._syncAttributes=function(){this.options.set("disabled",this.$element.prop("disabled"));this.options.get("disabled")?(this.isOpen()&&this.close(),this.trigger("disable",{})):this.trigger("enable",{})};b.prototype._syncSubtree=function(a,b){var c=!1,d=this;if(!a||
!a.target||"OPTION"===a.target.nodeName||"OPTGROUP"===a.target.nodeName){if(b)if(b.addedNodes&&0<b.addedNodes.length)for(var e=0;e<b.addedNodes.length;e++)b.addedNodes[e].selected&&(c=!0);else b.removedNodes&&0<b.removedNodes.length&&(c=!0);else c=!0;c&&this.dataAdapter.current(function(a){d.trigger("selection:update",{data:a})})}};b.prototype.trigger=function(a,c){var d=b.__super__.trigger,e={open:"opening",close:"closing",select:"selecting",unselect:"unselecting"};void 0===c&&(c={});if(a in e){var f=
...
var moqui={isString:function(a){return"string"===typeof a},isBoolean:function(a){return"boolean"===typeof a},isNumber:function(a){return"number"===typeof a},isArray:function(a){return"[object Array]"===Object.prototype.toString.call(a)},isFunction:function(a){return"[object Function]"===Object.prototype.toString.call(a)},isPlainObject:function(a){return null!=a&&"object"==typeof a&&"[object Object]"===Object.prototype.toString.call(a)},debounce:function(a,d){var c,b;return function(){var e=this,f=
arguments;clearTimeout(c);c=setTimeout(function(){c=null;b=a.apply(e,f)},d);return b}},makeColumnsConsistent:function(a){a=$("#"+a+" table");var d=[],c,b,e,f;for(c=0;c<a.length;c++)if(b=a[c],b.rows&&0!==b.rows.length){f=0;for(e=b.rows[f];5>f&&f<b.rows.length;)if((!e.cells||1>=e.cells.length)&&b.rows.length>f+1)f++,e=b.rows[f];else break;if(e.cells&&0!==e.cells.length)for(b=0;b<e.cells.length;b++){var g=$(e.cells[b]).width();if(!d[b]||d[b]<g)d[b]=g}}e=d.length;for(c=b=0;c<e;c++)b+=d[c];g=[];for(c=
0;c<e;c++)g[c]=100*d[c]/b;for(c=0;c<a.length;c++)if(b=a[c],b.rows&&0!==b.rows.length){f=0;for(e=b.rows[f];5>f&&f<b.rows.length;)if((!e.cells||1>=e.cells.length)&&b.rows.length>f+1)f++,e=b.rows[f];else break;if(e.cells&&0!==e.cells.length)for(b=0;b<e.cells.length;b++)e.cells[b].style.width=g[b]+"%"}},downloadData:function(a,d,c){a=new Blob([a],{type:c});if(window.navigator.msSaveOrOpenBlob)window.navigator.msSaveOrOpenBlob(a,d);else{var b=document.createElement("a"),e=URL.createObjectURL(a);b.href=
e;b.download=d;document.body.appendChild(b);b.click();setTimeout(function(){document.body.removeChild(b);window.URL.revokeObjectURL(e)},0)}},notifyNotification:function(a,d){if(a){var c={};a.topic&&a.topic.length&&(c.tag=a.topic);if(window.Notification&&"granted"===Notification.permission){var b=new Notification(a.title,c);a.link&&a.link.length&&(b.onclick=function(){window.open(a.link)})}else window.Notification&&"denied"!==Notification.permission?Notification.requestPermission(function(b){"granted"===
b?(b=new Notification(a.title,c),a.link&&a.link.length&&(b.onclick=function(){window.open(a.link)})):d(a)}):d(a)}},NotifyOptions:function(a,d,c,b){this.message=a;d&&(this.url=d);this.icon=b?b:"success"===c?"glyphicon glyphicon-ok-sign":"warning"===c?"glyphicon glyphicon-warning-sign":"danger"===c?"glyphicon glyphicon-exclamation-sign":"glyphicon glyphicon-info-sign"},NotifySettings:function(a){this.delay=4E3;this.offset={x:20,y:60};this.placement={from:"top",align:"right"};this.animate={enter:"animated fadeInDown",
exit:""};this.type=a?a:"info";this.template='\x3cdiv data-notify\x3d"container" class\x3d"notify-container col-xs-11 col-sm-3 alert alert-{0}" role\x3d"alert"\x3e\x3cbutton type\x3d"button" aria-hidden\x3d"true" class\x3d"close" data-notify\x3d"dismiss"\x3e\x26times;\x3c/button\x3e\x3cspan data-notify\x3d"icon"\x3e\x3c/span\x3e \x3cspan data-notify\x3d"message"\x3e{2}\x3c/span\x3e\x3ca href\x3d"{3}" target\x3d"{4}" data-notify\x3d"url"\x3e\x3c/a\x3e\x3c/div\x3e'},notifyGrowl:function(a){a&&($.notify(new moqui.NotifyOptions(a.title,
a.link,a.type,a.icon),new moqui.NotifySettings(a.type)),moqui.webrootVue&&moqui.webrootVue.addNotify(a.title,a.type))},NotificationClient:function(a){this.displayEnable=!0;this.webSocketUrl=a;this.topicListeners={};this.disableDisplay=function(){this.displayEnable=!1};this.enableDisplay=function(){this.displayEnable=!0};this.initWebSocket=function(){this.webSocket=new WebSocket(this.webSocketUrl);this.webSocket.clientObj=this;this.webSocket.onopen=function(a){this.clientObj.tryReopenCount=0;a=[];
for(var c in this.clientObj.topicListeners)a.push(c);this.send("subscribe:"+a.join(","))};this.webSocket.onmessage=function(a){var c=JSON.parse(a.data);(a=this.clientObj.topicListeners[c.topic])&&a.forEach(function(a){a(c,this)},this);(a=this.clientObj.topicListeners.ALL)&&a.forEach(function(a){a(c,this)},this)};this.webSocket.onclose=function(a){console.log(a);setTimeout(this.clientObj.tryReopen,3E4,this.clientObj)};this.webSocket.onerror=function(a){console.log(a)}};this.tryReopen=function(a){a.webSocket&&
...
this.lruList,b=-1,e=0;e<c.length;e++)if(c[e]===a){b=e;break}0<=b&&c.splice(b,1);c.unshift(a)}}};$.fn.select2.defaults.set("theme","bootstrap");$.fn.select2.defaults.set("minimumResultsForSearch","10");$.fn.select2.defaults.set("dropdownAutoWidth",!0);$.fn.select2.amd.require(["select2/selection/search"],function(a){var d=a.prototype.searchRemoveChoice;a.prototype.searchRemoveChoice=function(){d.apply(this,arguments);this.$search.val("")}});$.fn.select2.defaults.set("selectOnClose",!0);
$.fn.modal.Constructor.prototype.enforceFocus=function(){};$.validator.setDefaults({errorPlacement:function(a,d){d.parent(".twitter-typeahead").length?a.insertAfter(d.parent()):d.parent(".input-group").length?a.insertAfter(d.parent()):d.hasClass("select2-hidden-accessible")?a.insertAfter(d.next("span")):a.insertAfter(d)}});
$.validator.prototype.errorsFor=function(a){a=this.escapeCssMeta(this.idOrName(a));var d="label[for\x3d'"+a+"'], label[for\x3d'"+a+"'] *";"label"!==this.settings.errorElement&&(d=d+", #"+a+"-error");return this.errors().filter(d)};
$.validator.prototype.errors=function(){var a=this.settings.errorClass.split(" ").join(".");return this.errorContext.is&&this.errorContext.is("form")?$(this.currentForm.elements).parents().parents().find(this.settings.errorElement+"."+a):$(this.settings.errorElement+"."+a,this.errorContext)};
$.validator.prototype.elements=function(){var a=this,d={};return $(this.currentForm.elements).filter(":input, [contenteditable]").not(":submit, :reset, :image, :disabled").not(this.settings.ignore).filter(function(){var c=this.name||$(this).attr("name");!c&&window.console&&console.error("%o has no name assigned",this);this.hasAttribute("contenteditable")&&(this.form=$(this).closest("form")[0],this.name=c);return c in d||!a.objectLength($(this).rules())?!1:d[c]=!0})};
$.validator.prototype.init=function(){function a(a){!this.form&&this.hasAttribute("contenteditable")&&(this.form=$(this).closest("form")[0],this.name=$(this).attr("name"));var b=$.data(this.form,"validator"),c="on"+a.type.replace(/^validate/,""),d=b.settings;d[c]&&!$(this).is(d.ignore)&&d[c].call(b,this,a)}this.labelContainer=$(this.settings.errorLabelContainer);this.errorContext=this.labelContainer.length&&this.labelContainer||$(this.currentForm);this.containers=$(this.settings.errorContainer).add(this.settings.errorLabelContainer);
this.submitted={};this.valueCache={};this.pendingRequest=0;this.pending={};this.invalid={};this.reset();var d=this.groups={},c;$.each(this.settings.groups,function(a,b){"string"===typeof b&&(b=b.split(/\s/));$.each(b,function(b,c){d[c]=a})});c=this.settings.rules;$.each(c,function(a,b){c[a]=$.validator.normalizeRule(b)});var b=$(this.currentForm.elements).filter(":input, [contenteditable]").not(":submit, :reset, :image, :disabled").not(this.settings.ignore);b.on("focusin.validate focusout.validate keyup.validate",
a);b.on("click.validate","select, option, [type\x3d'radio'], [type\x3d'checkbox']",a)};$(function(){$(".select2-hidden-accessible").on("select2:select",function(a){$(this).valid()})});
Inputmask.extendAliases({"yyyy-mm-dd hh:mm":{mask:"y-1-2 h:s",placeholder:"yyyy-mm-dd hh:mm",alias:"datetime",separator:"-",leapday:"-02-29",regex:{val2pre:function(a){a=Inputmask.escapeRegex.call(this,a);return new RegExp("((0[13-9]|1[012])"+a+"[0-3])|(02"+a+"[0-2])")},val2:function(a){a=Inputmask.escapeRegex.call(this,a);return new RegExp("((0[1-9]|1[012])"+a+"(0[1-9]|[12][0-9]))|((0[13-9]|1[012])"+a+"30)|((0[13578]|1[02])"+a+"31)")},val1pre:/[01]/,val1:/0[1-9]|1[012]/},onKeyDown:function(a,d,c,
b){}}});
